...
public class StatisticsActivity extends Activity {
    protected void onCreate(Bundle savedInstanceState) {
        ...
        timer.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {stat.diaTimer();}
        });
        buzzer.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {stat.diaBuzzer();}
        });
        clear.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {stat.clear();}
        });
        email.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {stat.email();}
        });
    }
}
